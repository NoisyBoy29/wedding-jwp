        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="">
                    ...
                    <h4 class="h4 mt-4 pb-2" style="border-bottom: 1px solid #dee2e6!important;">Tambah Fitur Pelayanan Baru
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="title"  placeholder="Masukan fitur pelayanan">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" id="description" rows="3" placeholder="Penjelasan Fitur Pelayanan"></textarea>
                    </div>
