...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h4 class="h4 mt-4">Daftar buku tamu</h4>
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            ...
            <a class="btn btn-sm btn-info mr-2 " style="font-size: 12px;" href="guest_list.php?<?= $links; ?>"><i class="mdi mdi-account-plus mr-2"></i>Daftar buku tamu</a>
        </div>
    </div>
</div>
<?php
...
<div class="text-right mr-2 mb-3">
    <a class="btn btn-sm btn-success mr-2" href="guest_add.php?<?= $links; ?>"><i class="mdi mdi-account-plus mr-2"></i> Tambah tamu</a>
</div>
<table id="guest_list" class="table table-striped table-hover table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
    ...
    <thead>
        <tr>
            ...
            <th>Priority-type</th>
            <th>Out of town</th>
            <th>Hubungan dari mempelai</th>
            <th>Pesan pada mempelai</th>
            <th>Aksi</th>
        </tr>
    </thead>
    ...
    <?php foreach ($guest_list as $guest_list_rows) : ?>
        <tr>
            ...
            <td class="special"><?= ($guest_list_rows->relationship == 'b') ? 'Wanita': 'Pria'; ?></td>
            <td class="special"><?= trim_body($guest_list_rows->message); ?></td>
            <td class="special">
